...
export const OverallScoreCard = ({ seoReport }: OverallScoreCardProps) => {
  ...
  const getScoreGradient = (score: number) => {
    if (score >= 70) {
      ...
      return "bg-gradient-to-r from-gray-400 to-yellow-600";
    } else {
      return "bg-gradient-to-r from-gray-400 to-red-600";
    }
  };
