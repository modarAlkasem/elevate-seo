          ...
          {(seoReport?.recommendations || []).map((rec, idx) => {
            const priorityConfig = {
              ...
              medium: {
                ...
                badgeClass:
                  "bg-amber-100 text-amber-700 dark:text-amber-300 dark:bg-amber-900/50",
                icon: TrendingUp,
              },
              low: {
                bgClass:
            ...
            const config =
              priorityConfig[rec.priority] || priorityConfig.medium;
            ...
            return (
              <div
                key={idx}
                className={`p-6 rounded-xl border ${config.bgClass} ${config.borderClass} hover:shadow-lg transition-all duration-100 group`}
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`p-2 rounded-full bg-white/80 dark:bg-black/20 ${config.iconClass} shrink-0`}
                  >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-6 text-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="capitalize bg-green-50 dark:bg-green-950/20 px-2 py-1 rounded text-green-700 dark:text-green-300">
                          {rec.expected_impact}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
