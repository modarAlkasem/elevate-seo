  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-slate-950 dark:via-blue-950 dark:to-purple-950">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-32 lg:px-8">
          <div className="text-center">
            <Badge className="mb-4 bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-blue-700 dark:text-blue-300 border-blue-500/30 hover:from-blue-500/30 hover:to-purple-500/30">
              <Sparkles className="w-3 h-3 mr-1 text-yellow-500" /> Powered by
              Bright Data & Google Gemini
            </Badge>
      ...
      <section className="py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2  gap-8 lg:gap-12">
            {/** Starter Plan Card */}
            <Card className="relative overflow-hidden border-2 border-blue-200 dark:border-blue-800 hover:border-blue-400 dark:hover:blue-600 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 group bg-gradient-to-br from-blue-50/50  to-cayan-50/50 dark:from-blue-950/50 dark:to-cyan-950/50 ">
            ...
            {/** Pro Plan Card */}
            <Card className="relative overflow-hidden border-2 border-purple-300 dark:purple-blue-700 hover:border-purple-500 dark:hover:purple-500 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/10 group bg-gradient-to-br from-purple-50/80 via-pink-50/80 to-orange-50/80   dark:from-purple-950/50 dark:via-pink-950/80 dark:to-orange-950/50">
              ...
              <CardHeader className="relative">
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-2 rounded-lg bg-gradient-to-br from-purple-600 via-pink-600 to-orange-400 text-white">
                ...
                <CardDescription className="text-base">
                  ...
                  conversations with your SEO data using Gemini.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
      ...
      <section className="py-20">
        <div className="max-auto mx-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 fap-8 items-center justify-center opacity-60 hover:opacity-80 transition-opacity duration-300">
