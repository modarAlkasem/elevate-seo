...
class PerplexityPrompt(BasePrompt):
    """Perplexity scraper prompt for entity analysis"""
    ...
    def build(self, target: str) -> str:
        return self._clean(self.TEMPLATE.format(target=target))


perplexity_prompt = PerplexityPrompt()
